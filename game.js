...
window.onload = function(){
  ...
  player.move = function(){
    ...
    if (this.isMoving) {
      ...
      if(game.input.b){
        document.onclick = PromptOpens;
      } else if(!(game.input.b)) {
        document.onclick = PromptOpen;
      }
  ...
  GameDataSave = {
    action: function(){
      ...
      GameSaveData = JSON.stringify(GameSaveDataSample);
  ...
  var GameSaveDataOpen = {
    action: function(){
      ...
      GameDataSaveSample = getCookie(usersnames + "AttackGameSaveData");
      GameDataSave = JOSN.parse(GameDataSaveSample);
      player.hp = GameDataSave[0].hp;
      player.mp = GameDataSave[0].mp;
      player.inventory = GameDataSave[0].inventory;
      player.gp = GameDataSave[0].gp;
      player.exp = GameDataSave[0].exp;
      player.level = GameDataSave[0].level;
    }
  };
  var spriteRoles = [,,greeter,,cat,,,,,,,,,,,brawler,uragirimono,BossBattle,GameDataSave,GameSaveDataOpen]
